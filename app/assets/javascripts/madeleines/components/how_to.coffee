  ...
  render: ->
    ...
    div {className: 'how-to'},
      ...
      div({className: 'paragraph'}, 'You can save all the links you want, but
        ...
        that\'s all you get:')
      Picture({className: 'screenshot', src: 'todays-remembrance.png'})
      ...
      Picture({className: 'screenshot', src: 'drop-it.png'})
      ...
      Picture({className: 'screenshot', src: 'pick-it-up.png'})
      ...
      Picture({className: 'screenshot', src: 'baker.png'})
